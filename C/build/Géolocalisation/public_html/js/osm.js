...
function geolocalisationv2()
{
    var adresse = $("#AdresseATrouver").val();
    
     if(adresse===""){
             $("#AdresseATrouver").attr("placeholder","Il faut une adresse ! ");   
            }else{
                console.log(encodeURI(adresse));
    $.getJSON("https://api-adresse.data.gouv.fr/search/?q=" + adresse + "&limit=1")
            .done(function (resultat, status, xhr) {
...
$(document).ready(function () {
    ...
    $("#PositionnerAdresse").click(geolocalisationv2);
});
